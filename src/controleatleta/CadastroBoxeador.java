...
public class CadastroBoxeador extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tabelaListaJogadores.setModel(new javax.swing.table.DefaultTableModel 
            ...
            tabelaListaJogadores.addMouseListener(new java.awt.event.MouseAdapter() {
                public void mouseClicked(java.awt.event.MouseEvent evt) {
                    tabelaListaJogadoresMouseClicked(evt);
                }
            });
            jScrollPane4.setViewportView(tabelaListaJogadores);
...
private void tabelaListaJogadoresMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaListaJogadoresMouseClicked
    if (tabelaListaJogadores.isEnabled()) {
        DefaultTableModel model = (DefaultTableModel) tabelaListaJogadores.getModel();
        String nome = (String) model.getValueAt(tabelaListaJogadores.getSelectedRow(), 0);
        this.pesquisarBoxeador(nome);
    }
}//GEN-LAST:event_tabelaListaJogadoresMouseClicked
